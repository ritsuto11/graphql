...
type ComplexityRoot struct {
	...
	Mutation struct {
		CreateDevice func(childComplexity int, name string, userID string) int
...
type MutationResolver interface {
	...
	CreateDevice(ctx context.Context, name string, userID string) (*model.Device, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.createDevice":
		...
		return e.complexity.Mutation.CreateDevice(childComplexity, args["name"].(string), args["userId"].(string)), true
...
func (ec *executionContext) _Mutation_createDevice(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().CreateDevice(rctx, fc.Args["name"].(string), fc.Args["userId"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	fc.Result = res
	return ec.marshalNDevice2ᚖmy_gql_serverᚋgraphᚋmodelᚐDevice(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_devices(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*model.Device)
	fc.Result = res
	return ec.marshalNDevice2ᚕᚖmy_gql_serverᚋgraphᚋmodelᚐDeviceᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNDevice2my_gql_serverᚋgraphᚋmodelᚐDevice(ctx context.Context, sel ast.SelectionSet, v model.Device) graphql.Marshaler {
	return ec._Device(ctx, sel, &v)
}

func (ec *executionContext) marshalNDevice2ᚕᚖmy_gql_serverᚋgraphᚋmodelᚐDeviceᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Device) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNDevice2ᚖmy_gql_serverᚋgraphᚋmodelᚐDevice(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNDevice2ᚖmy_gql_serverᚋgraphᚋmodelᚐDevice(ctx context.Context, sel ast.SelectionSet, v *model.Device) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
